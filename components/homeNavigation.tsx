    ...
    return(
        <div className="w-screen h-fit">
            {(width>=1024)?<div className="w-0 h-0 lg:w-screen lg:h-fit invisible lg:visible">
                <div className='flex flex-row items-center w-full h-24 bg-blend-lighten bg-gray-950 border-zinc-500 border-b-2'>
                    <ScholarlyIcon />
                    <div className='space-x-16 ml-20 h-full flex flex-row items-center'>
            ...
            {(width<1024)?<div className="flex flex-col w-screen h-fit lg:invisible lg:w-0 lg:h-0">
                ...
                <div className="w-screen h-fit flex flex-col items-center">
                    <Collapse in={open}>
                        <div className="w-screen  pt-4 pb-3 h-fit flex flex-col items-center gap-y-5 bg-gradient-to-b from-zinc-500 to-[#121212]" >
