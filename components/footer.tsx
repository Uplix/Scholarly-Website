    ...
    <div className="w-screen flex flex-col h-fit bg-[#121826]">
      <div className="w-screen flex flex-row flex-wrap h-fit pt-12 pb-10 items-center justify-center gap-y-10">
        <div
          ...
          className="w-fit max-w-sm h-fit flex flex-col items-start ml-6"
        >
          <Image
            className="ml-1.5"
            alt="Logo"
            ...
            height={50}
          />
          <h5 className="text-lg text-start mt-3 opacity-70">
            Changing the realm of peer tutoring
          </h5>
          <div className="max-w-max h-fit flex flex-row mt-2 space-x-4">
            <Link
              href={"https://www.instagram.com/real_scholarly/"}
              className="w-fit h-fit transition hover:scale-110"
            >
              <Instagram sx={{ color: "GrayText" }} fontSize="medium" />
            </Link>
            <Link
              href={"https://twitter.com/RealScholarly"}
              className="w-fit h-fit transition hover:scale-110"
            >
          ...
          <div className="flex flex-row w-full gap-x-2 justify-start items-center mt-4">
            <button
              className="w-fit h-fit transition hover:scale-105"
        ...
        <div
          id="where to go"
          className="w-screen justify-center items-start flex flex-row max-w-xl gap-x-10"
        >
          <div className="flex flex-col items-start">
            ...
            <div className="flex flex-col items-start ml-1.5">
              <Link
                href={"/"}
                className="text-md text-right opacity-80 transition hover:scale-105 hover:underline decoration-2 decoration-zinc-300 underline-offset-2"
              >
                Home
              </Link>
              <Link
