...
export default function Home({ params }: { params: { district: string } }) {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center w-screen py-5">
      ...
      <h5 className="text-4xl text-center mt-7 max-w-xl px-8">
        What kind of account do you want to login to?
      </h5>
      <div className="flex flex-row flex-wrap items-center justify-center gap-x-16 gap-y-10 mt-12 px-8">
        <button
          onClick={studentLogin}
          className="bg-gradient-to-br transition from-indigo-500 from-15% via-sky-500 via-40% to-emerald-500 hover:scale-110 w-48 h-64 rounded-lg flex flex-col items-center justify-end"
        >
          <Image
        ...
        <button
          onClick={staffLogin}
          className="bg-gradient-to-bl transition from-indigo-500 from-15% via-sky-500 via-40% to-emerald-500 hover:scale-110 w-48 h-64 rounded-lg flex flex-col items-center justify-end"
        >
