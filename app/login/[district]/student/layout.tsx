    ...
    const TheMenu = () =>{
        return(
            ...
            <div className={menuClassName}>
                ...
                {isTutor?<Link href={'/login/'+params.district +'/student/available'} onClick={()=>{setTimeout(()=>closeMenu(),50)}} className='self-center text-center text-white text-5xl mt-16 transition ease-in-out delay-150 hover:scale-110 hover:-translate-y-1'>Available</Link>:null}
                <Link href={'/login/'+params.district +'/student/request'} onClick={()=>{setTimeout(()=>closeMenu(),50)}} className='self-center text-center text-white text-5xl mt-16 transition ease-in-out delay-150 hover:scale-110 hover:-translate-y-1'>Request</Link>
                <Link href={'/login/'+params.district +'/student/schedule'} onClick={()=>{setTimeout(()=>closeMenu(),50)}} className='self-center text-center text-white text-5xl mt-16 transition ease-in-out delay-150 hover:scale-110 hover:-translate-y-1'>Schedule</Link>
                <Link href={'/login/'+params.district +'/student/settings'} onClick={()=>{setTimeout(()=>closeMenu(),50)}} className='self-center text-center text-white text-5xl mt-16 transition ease-in-out delay-150 hover:scale-110 hover:-translate-y-1'>Settings</Link>
            </div>
        )
    }
