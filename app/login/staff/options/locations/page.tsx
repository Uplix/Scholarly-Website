...
export default function LocationEdit() {
  ...
  const [addLocationButtonColor, setAddLocationButtonColor] =
  ...
  const addLocation = () => {
    if (
      (locations.length > 0 && locations[locations.length - 1] == undefined) ||
